...
class User(AbstractUser):
    ...
    avatar = models.ImageField(upload_to='users_avatars', verbose_name='Аватар', help_text='Загрузите аватар', blank=True, null=True)
    tg_chat_id = models.CharField(max_length=50, blank=True, null=True, verbose_name='Телеграм chat-id', help_text='Укажите телеграм chat-id')
